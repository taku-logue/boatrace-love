...
Phase 4 MVPは完了済み。次の中心はPhase 5の特徴量設計・学習用データセット作成で、`apps/api/app/models/`、Phase 2/3/4のingestion成果物、`data/processed/`、今後追加する特徴量生成処理が主作業範囲になる。
...
| `docs/PHASE5_FEATURE_ENGINEERING.md` | 特徴量設計、学習用データセット作成の計画 | Phase 5実装前の最初の参照先 |
...
- 新しい特徴量テーブルや学習用Parquetを作る場合は、`docs/PHASE5_FEATURE_ENGINEERING.md`の完了条件と優先順位に合わせる
